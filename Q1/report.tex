...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_pnpp/loss}
  \caption{Loss of PointNet++}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_pnpp/accuracy}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_pnpp/least_erred_class_non_error}
  \caption{Correctly classified on the least erred class}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_pnpp/least_erred_class_error}
  \caption{Incorrectly classified on the least erred class}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_pnpp/most_erred_class_non_error}
  \caption{Correctly classified on the most erred class}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_pnpp/most_erred_class_error}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_gbnet/loss}
  \caption{Loss of GBNet}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_gbnet/accuracy}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_gbnet/least_erred_class_non_error}
  \caption{Correctly classified on the least erred class}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_gbnet/most_erred_class_non_error}
  \caption{Correctly classified on the most erred class}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{./results/graphs_gbnet/most_erred_class_error}
  \caption{Incorrectly classified on the most erred class}
\end{subfigure}
